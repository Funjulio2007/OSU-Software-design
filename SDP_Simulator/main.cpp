...
void credits()
{
    ...
    LCD.WriteLine ("Audacity was used to record voicelines, music, and\n sound effects");
    LCD.WriteLine ("Pixelart.io was used to make most of the pixel art\nChatGPT was used to generate the lanternfly sprite\nand the Obama sprite");
